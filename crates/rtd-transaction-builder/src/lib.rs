...
//! Transaction building API for the [Rtd] blockchain.
//!
...
//! resolves them into a finalized [`Transaction`](rtd_sdk_types::Transaction).
//!
//! [Rtd]: https://rtd.io
//!
//! # Feature flags
...
//! # Example
//!
//! Build a simple RTD transfer transaction offline using [`TransactionBuilder::try_build`]:
//!
//! ```
