...
use error::Error;
use rtd_types::Address;
use rtd_types::Argument;
use rtd_types::Command;
use rtd_types::GasPayment;
use rtd_types::Identifier;
use rtd_types::Input;
use rtd_types::MakeMoveVector;
use rtd_types::MergeCoins;
use rtd_types::MoveCall;
use rtd_types::ObjectReference;
use rtd_types::Publish;
use rtd_types::SharedInput;
use rtd_types::SplitCoins;
use rtd_types::Transaction;
use rtd_types::TransactionExpiration;
use rtd_types::TransferObjects;
use rtd_types::TypeTag;
use rtd_types::Upgrade;
...
impl TransactionBuilder {
    ...
    pub fn finish(self) -> Result<Transaction, Error> {
        ...
        Ok(Transaction {
            kind: rtd_types::TransactionKind::ProgrammableTransaction(
                rtd_types::ProgrammableTransaction {
                    inputs: self
                        .inputs
                        .into_iter()
...
//     use rtd_graphql_client::faucet::FaucetClient;
//     use rtd_graphql_client::Client;
//     use rtd_graphql_client::PaginationFilter;

//     use rtd_types::framework::Coin;
//     use rtd_types::Address;
//     use rtd_types::Digest;
//     use rtd_types::ExecutionStatus;
//     use rtd_types::IdOperation;
//     use rtd_types::ObjectType;
//     use rtd_types::TransactionEffects;
//     use rtd_types::TypeTag;
...
//     /// Type corresponding to the output of `rtd move build --dump-bytecode-as-base64`
...
//     /// This is used to read the json file that contains the modules/deps/digest generated with rtd
...
//     /// root of the rtd-transaction-builder crate.
...
//         client: &Client,
//         digest: Digest,
//         effects: Result<Option<TransactionEffects>, rtd_graphql_client::error::Error>,
//     ) {
...
//                             match change {
//                                 rtd_types::ObjectOut::PackageWrite { .. } => {
//                                     package_id = Some(obj.object_id);
//                                 }
//                                 rtd_types::ObjectOut::ObjectWrite { .. } => {
...
//                         rtd_types::Owner::Object(_) => {
//                             panic!("Upgrade capability controlled by object")
//                         }
//                         rtd_types::Owner::Immutable => panic!("Upgrade capability is stored immutably and cannot be used for upgrades"),
//                         rtd_types::Owner::ConsensusAddress { .. } => {
//                             upgrade_cap = Some(tx.input(&obj))
//                         }
