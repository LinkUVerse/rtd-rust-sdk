...
//! Rtd checkpoint summary.
//!
//! This test is the BLS half of the OCS-fixture pin in
//! `crates/rtd-sdk-types/tests/ocs_fixture.rs`. Together the two
...
//!    rtd-sdk-types test).
//!
//! The fixtures are shared with the rtd-sdk-types test and live at
//! `crates/rtd-sdk-types/tests/fixtures/ocs/`. They originate from
//! PR #223 of LinkUVerse/rtd-rust-sdk at commit 25a17590.
...
/// Path to a fixture file in the sister `rtd-sdk-types` crate's tests
...
macro_rules! sister_fixture {
    ($rel:literal) => {
        concat!(
            ...
            "/../rtd-sdk-types/tests/fixtures/ocs/",
            $rel,
        )
    };
}
