...
use rtd_sdk_types::Bn254FieldElement;
use rtd_sdk_types::CircomG1;
use rtd_sdk_types::CircomG2;
...
use rtd_sdk_types::ZkLoginInputs;
use rtd_sdk_types::ZkLoginProof;
...
/// Calculate the Rtd address based on address seed and address params.
#[allow(unused)]
fn gen_address_seed(
    salt: &str,
    name: &str,  // i.e. "sub"
