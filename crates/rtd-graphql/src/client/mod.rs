//! GraphQL client for Rtd blockchain.
...
impl Client {
    /// URL for the Rtd Foundation provided GraphQL service for mainnet.
    pub const MAINNET: &str = "https://graphql.mainnet.rtd.io/graphql";

    /// URL for the Rtd Foundation provided GraphQL service for testnet.
    pub const TESTNET: &str = "https://graphql.testnet.rtd.io/graphql";

    /// URL for the Rtd Foundation provided GraphQL service for devnet.
    pub const DEVNET: &str = "https://graphql.devnet.rtd.io/graphql";
    ...
    /// ```no_run
    /// use rtd_graphql::Client;
    /// use rtd_graphql::header::HeaderMap;
    /// use rtd_graphql::header::HeaderValue;
    ///
    ...
    ///
    /// Mirrors [`rtd_rpc::client::HeadersInterceptor::bearer_auth`] for
    ...
    ///
    /// Mirrors [`rtd_rpc::client::HeadersInterceptor::basic_auth`] for
    /// cross-transport API consistency.
