...
use rtd_sdk_types::TransactionEffects;
...
/// A balance change from a transaction (re-exported from rtd-rpc).
pub use rtd_rpc::proto::rtd::rpc::v2::BalanceChange;
...
impl Client {
    ...
    ///
    /// let client = Client::new("https://graphql.mainnet.rtd.io/graphql")?;
