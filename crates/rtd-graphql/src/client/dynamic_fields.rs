...
impl Client {
    ...
    async fn fetch_dynamic_fields_page_with_formats(
        ...
        const QUERY: &str = graphql_query!(
            ...
            query($parent: RtdAddress!, $cursor: String, $withJson: Boolean!, $withBcs: Boolean!) {
    ...
    async fn fetch_single_dynamic_field<N: Serialize>(
        ...
        const DYNAMIC_FIELD_QUERY: &str = graphql_query!(
            ...
            query($parent: RtdAddress!, $name: DynamicFieldName!, $withJson: Boolean!, $withBcs: Boolean!) {
                object(address: $parent) {
...
mod tests {
                            ...
                            "nodes": [
                                {
                                    ...
                                    "value": {
                                        ...
                                        "type": { "repr": "0x2::coin::Coin<0x2::rtd::RTD>" },
                                        "json": { "balance": "1000" }
                                    }
                                },
                                {
    ...
    async fn test_dynamic_field_object_type() {
        ...
        assert_eq!(
            ...
            "0x2::coin::Coin<0x2::rtd::RTD>".parse::<TypeTag>().unwrap()
        );
    }
