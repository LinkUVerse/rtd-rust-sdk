//! GraphQL scalar types for Rtd.

use std::borrow::Cow;

use serde::Deserialize;

/// `RtdAddress` scalar in Rtd GraphQL schema. 32-byte hex-encoded address with `0x` prefix.
pub use rtd_sdk_types::Address;

/// Useful for digest fields (Base58 string). Not a scalar in Rtd GraphQL schema.
pub use rtd_sdk_types::Digest;

/// `BigInt` scalar in Rtd GraphQL schema.
///
...
mod sealed {
    ...
    impl Numeric for rtd_sdk_types::U256 {}
}

/// `DateTime` scalar in Rtd GraphQL schema.
