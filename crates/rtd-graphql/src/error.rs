...
impl From<rtd_sdk_types::TypeParseError> for Error {
    fn from(err: rtd_sdk_types::TypeParseError) -> Self {
...
impl From<rtd_sdk_types::DigestParseError> for Error {
    fn from(err: rtd_sdk_types::DigestParseError) -> Self {
