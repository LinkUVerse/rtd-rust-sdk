impl serde::Serialize for GetCheckpointObjectProofRequest {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer
            .serialize_struct("rtd.rpc.v2alpha.GetCheckpointObjectProofRequest", len)?;
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(
                ...
                formatter
                    .write_str("struct rtd.rpc.v2alpha.GetCheckpointObjectProofRequest")
            }
            fn visit_map<V>(
                self,
                mut map_: V,
        ...
        deserializer
            .deserialize_struct(
                "rtd.rpc.v2alpha.GetCheckpointObjectProofRequest",
                FIELDS,
                GeneratedVisitor,
            )
    }
...
impl serde::Serialize for GetCheckpointObjectProofResponse {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer
            .serialize_struct("rtd.rpc.v2alpha.GetCheckpointObjectProofResponse", len)?;
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(
                ...
                formatter
                    .write_str("struct rtd.rpc.v2alpha.GetCheckpointObjectProofResponse")
            }
            fn visit_map<V>(
                self,
                mut map_: V,
        ...
        deserializer
            .deserialize_struct(
                "rtd.rpc.v2alpha.GetCheckpointObjectProofResponse",
                FIELDS,
                GeneratedVisitor,
            )
    }
...
impl serde::Serialize for MerkleNeighbourLeaf {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer
            .serialize_struct("rtd.rpc.v2alpha.MerkleNeighbourLeaf", len)?;
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(
                ...
                formatter.write_str("struct rtd.rpc.v2alpha.MerkleNeighbourLeaf")
            }
            fn visit_map<V>(
                self,
                mut map_: V,
        ...
        deserializer
            .deserialize_struct(
                "rtd.rpc.v2alpha.MerkleNeighbourLeaf",
                FIELDS,
                GeneratedVisitor,
            )
    }
...
impl serde::Serialize for MerkleNode {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer
            .serialize_struct("rtd.rpc.v2alpha.MerkleNode", len)?;
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(
                ...
                formatter.write_str("struct rtd.rpc.v2alpha.MerkleNode")
            }
            fn visit_map<V>(
                self,
                mut map_: V,
        ...
        deserializer
            .deserialize_struct("rtd.rpc.v2alpha.MerkleNode", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for MerkleNonInclusionProof {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer
            .serialize_struct("rtd.rpc.v2alpha.MerkleNonInclusionProof", len)?;
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(
                ...
                formatter.write_str("struct rtd.rpc.v2alpha.MerkleNonInclusionProof")
            }
            fn visit_map<V>(
                self,
                mut map_: V,
        ...
        deserializer
            .deserialize_struct(
                "rtd.rpc.v2alpha.MerkleNonInclusionProof",
                FIELDS,
                GeneratedVisitor,
            )
    }
...
impl serde::Serialize for MerkleProof {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer
            .serialize_struct("rtd.rpc.v2alpha.MerkleProof", len)?;
        if !self.path.is_empty() {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(
                ...
                formatter.write_str("struct rtd.rpc.v2alpha.MerkleProof")
            }
            fn visit_map<V>(
                self,
                mut map_: V,
        ...
        deserializer
            .deserialize_struct("rtd.rpc.v2alpha.MerkleProof", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for OcsInclusionProof {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer
            .serialize_struct("rtd.rpc.v2alpha.OcsInclusionProof", len)?;
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(
                ...
                formatter.write_str("struct rtd.rpc.v2alpha.OcsInclusionProof")
            }
            fn visit_map<V>(
                self,
                mut map_: V,
        ...
        deserializer
            .deserialize_struct(
                "rtd.rpc.v2alpha.OcsInclusionProof",
                FIELDS,
                GeneratedVisitor,
            )
    }
...
impl serde::Serialize for OcsNonInclusionProof {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer
            .serialize_struct("rtd.rpc.v2alpha.OcsNonInclusionProof", len)?;
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(
                ...
                formatter.write_str("struct rtd.rpc.v2alpha.OcsNonInclusionProof")
            }
            fn visit_map<V>(
                self,
                mut map_: V,
        ...
        deserializer
            .deserialize_struct(
                "rtd.rpc.v2alpha.OcsNonInclusionProof",
                FIELDS,
                GeneratedVisitor,
            )
    }
