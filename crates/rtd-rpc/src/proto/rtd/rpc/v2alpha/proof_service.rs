...
//! in-memory proof / Merkle types in `rtd_sdk_types`.
//!
...
use rtd_sdk_types::ObjectReference;
use rtd_sdk_types::merkle::MerkleNonInclusionProof as SdkMerkleNonInclusionProof;
use rtd_sdk_types::merkle::Node;
use rtd_sdk_types::proof::OcsInclusionProof as SdkOcsInclusionProof;
use rtd_sdk_types::proof::OcsNonInclusionProof as SdkOcsNonInclusionProof;
...
impl From<&rtd_sdk_types::merkle::MerkleProof> for MerkleProof {
    fn from(value: &rtd_sdk_types::merkle::MerkleProof) -> Self {
        Self {
...
impl TryFrom<&MerkleProof> for rtd_sdk_types::merkle::MerkleProof {
    type Error = TryFromProtoError;
    ...
    fn try_from(value: &MerkleProof) -> Result<Self, Self::Error> {
        ...
        Ok(rtd_sdk_types::merkle::MerkleProof::new(path))
    }
}

impl From<&(ObjectReference, rtd_sdk_types::merkle::MerkleProof)> for MerkleNeighbourLeaf {
    fn from(value: &(ObjectReference, rtd_sdk_types::merkle::MerkleProof)) -> Self {
...
impl TryFrom<&MerkleNeighbourLeaf> for (ObjectReference, rtd_sdk_types::merkle::MerkleProof) {
    type Error = TryFromProtoError;
    ...
    fn try_from(value: &MerkleNeighbourLeaf) -> Result<Self, Self::Error> {
        ...
        let proof = rtd_sdk_types::merkle::MerkleProof::try_from(proof_proto)
...
impl TryFrom<&MerkleNonInclusionProof> for SdkMerkleNonInclusionProof<ObjectReference> {
    ...
    fn try_from(value: &MerkleNonInclusionProof) -> Result<Self, Self::Error> {
        ...
        let left_leaf = value
            ...
            .as_ref()
            .map(|l| {
                <(ObjectReference, rtd_sdk_types::merkle::MerkleProof)>::try_from(l)
...
impl TryFrom<&OcsInclusionProof> for SdkOcsInclusionProof {
    ...
    fn try_from(value: &OcsInclusionProof) -> Result<Self, Self::Error> {
        ...
        let merkle_proof = rtd_sdk_types::merkle::MerkleProof::try_from(merkle_proof_proto)
...
mod tests {
    ...
    use rtd_sdk_types::merkle::MerkleTree;
    ...
    fn merkle_proof_round_trip_via_proto() {
        ...
        for (index, leaf) in LEAVES.iter().enumerate() {
            ...
            let round_tripped: rtd_sdk_types::merkle::MerkleProof = (&proto).try_into().unwrap();
    ...
    fn malformed_inner_node_reports_path_index() {
        ...
        let err = rtd_sdk_types::merkle::MerkleProof::try_from(&tree_proof).unwrap_err();
    ...
    fn synthetic_refs(count: u8) -> Vec<ObjectReference> {
        (0..count)
            .map(|i| {
                ...
                digest[0] = i ^ 0x42;
                ObjectReference::new(
                    rtd_sdk_types::Address::new(addr),
                    u64::from(i) + 1,
                    Digest::new(digest),
                )
            })
    ...
    fn ocs_non_inclusion_proof_round_trip_via_proto() {
        ...
        let before = ObjectReference::new(
            rtd_sdk_types::Address::new([0u8; 32]),
            0,
            Digest::new([0u8; 32]),
        );
        // After everything.
    ...
    fn merkle_neighbour_leaf_missing_leaf_rejected() {
        ...
        let err =
            <(ObjectReference, rtd_sdk_types::merkle::MerkleProof)>::try_from(&proto).unwrap_err();
        assert_eq!(
