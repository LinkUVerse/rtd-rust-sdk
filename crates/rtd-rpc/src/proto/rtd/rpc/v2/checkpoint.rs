...
impl From<rtd_sdk_types::CheckpointSummary> for CheckpointSummary {
    fn from(summary: rtd_sdk_types::CheckpointSummary) -> Self {
        Self::merge_from(summary, &FieldMaskTree::new_wildcard())
    }
}

impl Merge<rtd_sdk_types::CheckpointSummary> for CheckpointSummary {
    fn merge(&mut self, source: rtd_sdk_types::CheckpointSummary, mask: &FieldMaskTree) {
        ...
        let rtd_sdk_types::CheckpointSummary {
            epoch,
            sequence_number,
...
impl TryFrom<&CheckpointSummary> for rtd_sdk_types::CheckpointSummary {
...
impl From<rtd_sdk_types::GasCostSummary> for GasCostSummary {
    fn from(
        rtd_sdk_types::GasCostSummary {
            computation_cost,
            storage_cost,
            storage_rebate,
...
impl TryFrom<&GasCostSummary> for rtd_sdk_types::GasCostSummary {
    type Error = TryFromProtoError;
...
impl From<rtd_sdk_types::CheckpointCommitment> for CheckpointCommitment {
    fn from(value: rtd_sdk_types::CheckpointCommitment) -> Self {
        use checkpoint_commitment::CheckpointCommitmentKind;

        let mut message = Self::default();

        let kind = match value {
            rtd_sdk_types::CheckpointCommitment::EcmhLiveObjectSet { digest } => {
                message.digest = Some(digest.to_string());
                CheckpointCommitmentKind::EcmhLiveObjectSet
            }
            rtd_sdk_types::CheckpointCommitment::CheckpointArtifacts { digest } => {
                message.digest = Some(digest.to_string());
...
impl TryFrom<&CheckpointCommitment> for rtd_sdk_types::CheckpointCommitment {
    type Error = TryFromProtoError;
...
impl From<rtd_sdk_types::EndOfEpochData> for EndOfEpochData {
    fn from(
        rtd_sdk_types::EndOfEpochData {
...
impl TryFrom<&EndOfEpochData> for rtd_sdk_types::EndOfEpochData {
    type Error = TryFromProtoError;
...
impl From<&rtd_sdk_types::CheckpointTransactionInfo> for CheckpointedTransactionInfo {
    fn from(value: &rtd_sdk_types::CheckpointTransactionInfo) -> Self {
        Self {
...
impl TryFrom<&CheckpointedTransactionInfo> for rtd_sdk_types::CheckpointTransactionInfo {
    type Error = TryFromProtoError;
    ...
    fn try_from(value: &CheckpointedTransactionInfo) -> Result<Self, Self::Error> {
        ...
        let signatures: Vec<rtd_sdk_types::UserSignature> = value
            .signatures
            .iter()
            .map(TryInto::try_into)
            .collect::<Result<_, _>>()?;
...
impl From<rtd_sdk_types::CheckpointContents> for CheckpointContents {
    fn from(value: rtd_sdk_types::CheckpointContents) -> Self {
        Self::merge_from(value, &FieldMaskTree::new_wildcard())
    }
}

impl Merge<rtd_sdk_types::CheckpointContents> for CheckpointContents {
    fn merge(&mut self, source: rtd_sdk_types::CheckpointContents, mask: &FieldMaskTree) {
        if mask.contains(Self::BCS_FIELD.name) {
            let mut bcs = Bcs::serialize(&source).unwrap();
...
impl TryFrom<&CheckpointContents> for rtd_sdk_types::CheckpointContents {
    type Error = TryFromProtoError;
...
impl Merge<&rtd_sdk_types::CheckpointSummary> for Checkpoint {
    fn merge(&mut self, source: &rtd_sdk_types::CheckpointSummary, mask: &FieldMaskTree) {
        if mask.contains(Self::SEQUENCE_NUMBER_FIELD.name) {
...
impl Merge<rtd_sdk_types::ValidatorAggregatedSignature> for Checkpoint {
    fn merge(&mut self, source: rtd_sdk_types::ValidatorAggregatedSignature, mask: &FieldMaskTree) {
...
impl Merge<rtd_sdk_types::CheckpointContents> for Checkpoint {
    fn merge(&mut self, source: rtd_sdk_types::CheckpointContents, mask: &FieldMaskTree) {
