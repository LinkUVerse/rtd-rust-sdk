...
impl From<rtd_sdk_types::BalanceChange> for BalanceChange {
    fn from(value: rtd_sdk_types::BalanceChange) -> Self {
        Self {
...
impl Merge<&rtd_sdk_types::BalanceChange> for BalanceChange {
    fn merge(&mut self, source: &rtd_sdk_types::BalanceChange, mask: &crate::field::FieldMaskTree) {
...
impl TryFrom<&BalanceChange> for rtd_sdk_types::BalanceChange {
