...
impl From<rtd_sdk_types::Transaction> for Transaction {
    fn from(value: rtd_sdk_types::Transaction) -> Self {
        Self::merge_from(value, &FieldMaskTree::new_wildcard())
    }
}

impl Merge<rtd_sdk_types::Transaction> for Transaction {
    fn merge(&mut self, source: rtd_sdk_types::Transaction, mask: &FieldMaskTree) {
...
impl TryFrom<&Transaction> for rtd_sdk_types::Transaction {
...
impl From<rtd_sdk_types::GasPayment> for GasPayment {
    fn from(value: rtd_sdk_types::GasPayment) -> Self {
        Self {
...
impl TryFrom<&GasPayment> for rtd_sdk_types::GasPayment {
    type Error = TryFromProtoError;
...
impl From<rtd_sdk_types::TransactionExpiration> for TransactionExpiration {
    fn from(value: rtd_sdk_types::TransactionExpiration) -> Self {
        use rtd_sdk_types::TransactionExpiration::*;
...
impl TryFrom<&TransactionExpiration> for rtd_sdk_types::TransactionExpiration {
    type Error = TryFromProtoError;
...
impl From<rtd_sdk_types::TransactionKind> for TransactionKind {
    fn from(value: rtd_sdk_types::TransactionKind) -> Self {
        use rtd_sdk_types::TransactionKind as K;
...
impl TryFrom<&TransactionKind> for rtd_sdk_types::TransactionKind {
    type Error = TryFromProtoError;
...
impl From<rtd_sdk_types::ConsensusCommitPrologue> for ConsensusCommitPrologue {
    fn from(value: rtd_sdk_types::ConsensusCommitPrologue) -> Self {
        Self {
...
impl TryFrom<&ConsensusCommitPrologue> for rtd_sdk_types::ConsensusCommitPrologue {
    type Error = TryFromProtoError;
...
impl From<rtd_sdk_types::ConsensusCommitPrologueV2> for ConsensusCommitPrologue {
    fn from(value: rtd_sdk_types::ConsensusCommitPrologueV2) -> Self {
        Self {
            epoch: Some(value.epoch),
            round: Some(value.round),
            commit_timestamp: Some(crate::proto::timestamp_ms_to_proto(
...
impl TryFrom<&ConsensusCommitPrologue> for rtd_sdk_types::ConsensusCommitPrologueV2 {
    type Error = TryFromProtoError;
...
impl From<rtd_sdk_types::ConsensusCommitPrologueV3> for ConsensusCommitPrologue {
    fn from(value: rtd_sdk_types::ConsensusCommitPrologueV3) -> Self {
        Self {
            epoch: Some(value.epoch),
            round: Some(value.round),
            commit_timestamp: Some(crate::proto::timestamp_ms_to_proto(
...
impl TryFrom<&ConsensusCommitPrologue> for rtd_sdk_types::ConsensusCommitPrologueV3 {
    type Error = TryFromProtoError;
...
impl From<rtd_sdk_types::ConsensusCommitPrologueV4> for ConsensusCommitPrologue {
    fn from(
        rtd_sdk_types::ConsensusCommitPrologueV4 {
            epoch,
            round,
            sub_dag_index,
            commit_timestamp_ms,
...
impl TryFrom<&ConsensusCommitPrologue> for rtd_sdk_types::ConsensusCommitPrologueV4 {
    type Error = TryFromProtoError;
...
impl From<rtd_sdk_types::ConsensusDeterminedVersionAssignments>
    for ConsensusDeterminedVersionAssignments
{
    fn from(value: rtd_sdk_types::ConsensusDeterminedVersionAssignments) -> Self {
        use rtd_sdk_types::ConsensusDeterminedVersionAssignments::*;
...
impl TryFrom<&ConsensusDeterminedVersionAssignments>
    for rtd_sdk_types::ConsensusDeterminedVersionAssignments
{
    type Error = TryFromProtoError;
...
impl From<rtd_sdk_types::CanceledTransaction> for CanceledTransaction {
    fn from(value: rtd_sdk_types::CanceledTransaction) -> Self {
        Self {
...
impl TryFrom<&CanceledTransaction> for rtd_sdk_types::CanceledTransaction {
    type Error = TryFromProtoError;
...
impl From<rtd_sdk_types::CanceledTransactionV2> for CanceledTransaction {
    fn from(value: rtd_sdk_types::CanceledTransactionV2) -> Self {
        Self {
            digest: Some(value.digest.to_string()),
            version_assignments: value
                .version_assignments
...
impl TryFrom<&CanceledTransaction> for rtd_sdk_types::CanceledTransactionV2 {
    type Error = TryFromProtoError;
...
impl From<rtd_sdk_types::VersionAssignment> for VersionAssignment {
    fn from(value: rtd_sdk_types::VersionAssignment) -> Self {
        Self {
...
impl TryFrom<&VersionAssignment> for rtd_sdk_types::VersionAssignment {
    type Error = TryFromProtoError;
...
impl From<rtd_sdk_types::VersionAssignmentV2> for VersionAssignment {
    fn from(value: rtd_sdk_types::VersionAssignmentV2) -> Self {
        Self {
            object_id: Some(value.object_id.to_string()),
...
impl TryFrom<&VersionAssignment> for rtd_sdk_types::VersionAssignmentV2 {
    type Error = TryFromProtoError;
...
impl From<rtd_sdk_types::GenesisTransaction> for GenesisTransaction {
    fn from(value: rtd_sdk_types::GenesisTransaction) -> Self {
        Self {
            objects: value.objects.into_iter().map(Into::into).collect(),
        }
    }
...
impl TryFrom<&GenesisTransaction> for rtd_sdk_types::GenesisTransaction {
    type Error = TryFromProtoError;
...
impl From<rtd_sdk_types::RandomnessStateUpdate> for RandomnessStateUpdate {
    fn from(value: rtd_sdk_types::RandomnessStateUpdate) -> Self {
        Self {
            epoch: Some(value.epoch),
...
impl TryFrom<&RandomnessStateUpdate> for rtd_sdk_types::RandomnessStateUpdate {
    type Error = TryFromProtoError;
...
impl From<rtd_sdk_types::AuthenticatorStateUpdate> for AuthenticatorStateUpdate {
    fn from(value: rtd_sdk_types::AuthenticatorStateUpdate) -> Self {
        Self {
            epoch: Some(value.epoch),
            round: Some(value.round),
...
impl TryFrom<&AuthenticatorStateUpdate> for rtd_sdk_types::AuthenticatorStateUpdate {
    type Error = TryFromProtoError;
...
impl From<rtd_sdk_types::Jwk> for Jwk {
    fn from(rtd_sdk_types::Jwk { kty, e, n, alg }: rtd_sdk_types::Jwk) -> Self {
        Self {
            kty: Some(kty),
            e: Some(e),
            n: Some(n),
...
impl TryFrom<&Jwk> for rtd_sdk_types::Jwk {
    type Error = TryFromProtoError;
...
impl From<rtd_sdk_types::JwkId> for JwkId {
    fn from(rtd_sdk_types::JwkId { iss, kid }: rtd_sdk_types::JwkId) -> Self {
        Self {
            iss: Some(iss),
            kid: Some(kid),
        }
...
impl From<&rtd_sdk_types::JwkId> for JwkId {
    fn from(value: &rtd_sdk_types::JwkId) -> Self {
        Self {
...
impl TryFrom<&JwkId> for rtd_sdk_types::JwkId {
    type Error = TryFromProtoError;
...
impl From<rtd_sdk_types::ActiveJwk> for ActiveJwk {
    fn from(value: rtd_sdk_types::ActiveJwk) -> Self {
        Self {
...
impl TryFrom<&ActiveJwk> for rtd_sdk_types::ActiveJwk {
    type Error = TryFromProtoError;
...
impl From<rtd_sdk_types::ChangeEpoch> for ChangeEpoch {
    fn from(value: rtd_sdk_types::ChangeEpoch) -> Self {
        Self {
            epoch: Some(value.epoch),
...
impl TryFrom<&ChangeEpoch> for rtd_sdk_types::ChangeEpoch {
    type Error = TryFromProtoError;
...
impl From<rtd_sdk_types::SystemPackage> for SystemPackage {
    fn from(value: rtd_sdk_types::SystemPackage) -> Self {
        Self {
            version: Some(value.version),
...
impl TryFrom<&SystemPackage> for rtd_sdk_types::SystemPackage {
    type Error = TryFromProtoError;
...
impl From<rtd_sdk_types::EndOfEpochTransactionKind> for EndOfEpochTransactionKind {
    fn from(value: rtd_sdk_types::EndOfEpochTransactionKind) -> Self {
        use end_of_epoch_transaction_kind::Kind;
        use rtd_sdk_types::EndOfEpochTransactionKind as K;
...
impl TryFrom<&EndOfEpochTransactionKind> for rtd_sdk_types::EndOfEpochTransactionKind {
    type Error = TryFromProtoError;
...
impl From<rtd_sdk_types::AuthenticatorStateExpire> for AuthenticatorStateExpire {
    fn from(value: rtd_sdk_types::AuthenticatorStateExpire) -> Self {
        Self {
...
impl TryFrom<&AuthenticatorStateExpire> for rtd_sdk_types::AuthenticatorStateExpire {
    type Error = TryFromProtoError;
...
impl From<rtd_sdk_types::ExecutionTimeObservations> for ExecutionTimeObservations {
    fn from(value: rtd_sdk_types::ExecutionTimeObservations) -> Self {
        match value {
            rtd_sdk_types::ExecutionTimeObservations::V1(vec) => Self {
                version: Some(1),
...
impl TryFrom<&ExecutionTimeObservations> for rtd_sdk_types::ExecutionTimeObservations {
    type Error = TryFromProtoError;
...
impl
    From<(
        rtd_sdk_types::ExecutionTimeObservationKey,
        Vec<rtd_sdk_types::ValidatorExecutionTimeObservation>,
    )> for ExecutionTimeObservation
{
    fn from(
        ...
        use rtd_sdk_types::ExecutionTimeObservationKey;
    ...
    )
{
    ...
    fn try_from(value: &ExecutionTimeObservation) -> Result<Self, Self::Error> {
        ...
        let observations = value
            ...
            .iter()
            .map(rtd_sdk_types::ValidatorExecutionTimeObservation::try_from)
            .collect::<Result<_, _>>()?;
...
impl From<rtd_sdk_types::ValidatorExecutionTimeObservation> for ValidatorExecutionTimeObservation {
    fn from(value: rtd_sdk_types::ValidatorExecutionTimeObservation) -> Self {
        Self {
...
impl TryFrom<&ValidatorExecutionTimeObservation>
    for rtd_sdk_types::ValidatorExecutionTimeObservation
{
    type Error = TryFromProtoError;
    ...
    fn try_from(value: &ValidatorExecutionTimeObservation) -> Result<Self, Self::Error> {
        Ok(Self {
            validator: value
                ...
                .as_ref()
                .pipe(rtd_sdk_types::Bls12381PublicKey::from_bytes)
                .map_err(|e| {
                    TryFromProtoError::invalid(
...
impl From<rtd_sdk_types::ProgrammableTransaction> for ProgrammableTransaction {
    fn from(value: rtd_sdk_types::ProgrammableTransaction) -> Self {
        Self {
...
impl TryFrom<&ProgrammableTransaction> for rtd_sdk_types::ProgrammableTransaction {
    type Error = TryFromProtoError;
...
impl From<rtd_sdk_types::Input> for Input {
    fn from(value: rtd_sdk_types::Input) -> Self {
        use input::InputKind;
...
impl TryFrom<&Input> for rtd_sdk_types::Input {
    type Error = TryFromProtoError;
    ...
    fn try_from(value: &Input) -> Result<Self, Self::Error> {
        ...
        match value.kind() {
            ...
            InputKind::ImmutableOrOwned => {
                ...
                let reference = rtd_sdk_types::ObjectReference::new(object_id, version, digest);
            ...
            InputKind::Shared => {
                ...
                let shared_input = match value.mutability() {
                    input::Mutability::Unknown => {
                        ...
                        rtd_sdk_types::SharedInput::new(object_id, initial_shared_version, mutable)
                    }
                    input::Mutability::Immutable => rtd_sdk_types::SharedInput::new(
                        object_id,
                        initial_shared_version,
                        rtd_sdk_types::Mutability::Immutable,
                    ),
                    input::Mutability::Mutable => rtd_sdk_types::SharedInput::new(
                        object_id,
                        initial_shared_version,
                        rtd_sdk_types::Mutability::Mutable,
                    ),
                    input::Mutability::NonExclusiveWrite => rtd_sdk_types::SharedInput::new(
                        object_id,
                        initial_shared_version,
                        rtd_sdk_types::Mutability::NonExclusiveWrite,
                    ),
                };
...
impl From<rtd_sdk_types::Mutability> for input::Mutability {
    fn from(value: rtd_sdk_types::Mutability) -> Self {
        match value {
            rtd_sdk_types::Mutability::Immutable => Self::Immutable,
            rtd_sdk_types::Mutability::Mutable => Self::Mutable,
            rtd_sdk_types::Mutability::NonExclusiveWrite => Self::NonExclusiveWrite,
        }
    }
}
...
impl From<rtd_sdk_types::FundsWithdrawal> for FundsWithdrawal {
    fn from(value: rtd_sdk_types::FundsWithdrawal) -> Self {
        let mut message = Self::default();
...
impl TryFrom<&FundsWithdrawal> for rtd_sdk_types::FundsWithdrawal {
    type Error = TryFromProtoError;
...
impl From<rtd_sdk_types::WithdrawFrom> for funds_withdrawal::Source {
    fn from(value: rtd_sdk_types::WithdrawFrom) -> Self {
        match value {
...
impl From<rtd_sdk_types::Argument> for Argument {
    fn from(value: rtd_sdk_types::Argument) -> Self {
...
impl TryFrom<&Argument> for rtd_sdk_types::Argument {
    type Error = TryFromProtoError;
...
impl From<rtd_sdk_types::Command> for Command {
    fn from(value: rtd_sdk_types::Command) -> Self {
        use command::Command;
...
impl TryFrom<&Command> for rtd_sdk_types::Command {
    type Error = TryFromProtoError;
...
impl From<rtd_sdk_types::MoveCall> for MoveCall {
    fn from(value: rtd_sdk_types::MoveCall) -> Self {
        Self {
...
impl TryFrom<&MoveCall> for rtd_sdk_types::MoveCall {
    type Error = TryFromProtoError;
...
impl From<rtd_sdk_types::TransferObjects> for TransferObjects {
    fn from(value: rtd_sdk_types::TransferObjects) -> Self {
        Self {
            objects: value.objects.into_iter().map(Into::into).collect(),
...
impl TryFrom<&TransferObjects> for rtd_sdk_types::TransferObjects {
    type Error = TryFromProtoError;
...
impl From<rtd_sdk_types::SplitCoins> for SplitCoins {
    fn from(value: rtd_sdk_types::SplitCoins) -> Self {
        Self {
...
impl TryFrom<&SplitCoins> for rtd_sdk_types::SplitCoins {
    type Error = TryFromProtoError;
...
impl From<rtd_sdk_types::MergeCoins> for MergeCoins {
    fn from(value: rtd_sdk_types::MergeCoins) -> Self {
        Self {
            coin: Some(value.coin.into()),
...
impl TryFrom<&MergeCoins> for rtd_sdk_types::MergeCoins {
    type Error = TryFromProtoError;
...
impl From<rtd_sdk_types::Publish> for Publish {
    fn from(value: rtd_sdk_types::Publish) -> Self {
        Self {
            modules: value.modules.into_iter().map(Into::into).collect(),
            dependencies: value.dependencies.iter().map(ToString::to_string).collect(),
        }
...
impl TryFrom<&Publish> for rtd_sdk_types::Publish {
    type Error = TryFromProtoError;
...
impl From<rtd_sdk_types::MakeMoveVector> for MakeMoveVector {
    fn from(value: rtd_sdk_types::MakeMoveVector) -> Self {
        Self {
...
impl TryFrom<&MakeMoveVector> for rtd_sdk_types::MakeMoveVector {
    type Error = TryFromProtoError;
...
impl From<rtd_sdk_types::Upgrade> for Upgrade {
    fn from(value: rtd_sdk_types::Upgrade) -> Self {
        Self {
            modules: value.modules.into_iter().map(Into::into).collect(),
            dependencies: value.dependencies.iter().map(ToString::to_string).collect(),
            package: Some(value.package.to_string()),
...
impl TryFrom<&Upgrade> for rtd_sdk_types::Upgrade {
    type Error = TryFromProtoError;
