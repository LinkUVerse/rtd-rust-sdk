...
impl From<rtd_sdk_types::Event> for Event {
    fn from(value: rtd_sdk_types::Event) -> Self {
        Self::merge_from(value, &FieldMaskTree::new_wildcard())
    }
}

impl Merge<rtd_sdk_types::Event> for Event {
    fn merge(&mut self, source: rtd_sdk_types::Event, mask: &FieldMaskTree) {
...
impl TryFrom<&Event> for rtd_sdk_types::Event {
...
impl From<rtd_sdk_types::TransactionEvents> for TransactionEvents {
    fn from(value: rtd_sdk_types::TransactionEvents) -> Self {
        Self::merge_from(value, &FieldMaskTree::new_wildcard())
    }
}

impl Merge<rtd_sdk_types::TransactionEvents> for TransactionEvents {
    fn merge(&mut self, source: rtd_sdk_types::TransactionEvents, mask: &FieldMaskTree) {
...
impl TryFrom<&TransactionEvents> for rtd_sdk_types::TransactionEvents {
    type Error = TryFromProtoError;
