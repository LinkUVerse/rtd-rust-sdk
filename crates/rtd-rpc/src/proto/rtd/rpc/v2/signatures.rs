...
impl From<rtd_sdk_types::ValidatorAggregatedSignature> for ValidatorAggregatedSignature {
    fn from(value: rtd_sdk_types::ValidatorAggregatedSignature) -> Self {
...
impl TryFrom<&ValidatorAggregatedSignature> for rtd_sdk_types::ValidatorAggregatedSignature {
    ...
    fn try_from(value: &ValidatorAggregatedSignature) -> Result<Self, Self::Error> {
        ...
        let signature = value
            ...
            .as_ref()
            .pipe(rtd_sdk_types::Bls12381Signature::from_bytes)
            .map_err(|e| {
                TryFromProtoError::invalid(ValidatorAggregatedSignature::SIGNATURE_FIELD, e)
            })?;
        let bitmap = rtd_sdk_types::Bitmap::deserialize_from(value.bitmap()).map_err(|e| {
...
impl From<rtd_sdk_types::ValidatorCommitteeMember> for ValidatorCommitteeMember {
    fn from(value: rtd_sdk_types::ValidatorCommitteeMember) -> Self {
        Self {
...
impl TryFrom<&ValidatorCommitteeMember> for rtd_sdk_types::ValidatorCommitteeMember {
    type Error = TryFromProtoError;
...
impl From<rtd_sdk_types::ValidatorCommittee> for ValidatorCommittee {
    fn from(value: rtd_sdk_types::ValidatorCommittee) -> Self {
        Self {
            epoch: Some(value.epoch),
...
impl TryFrom<&ValidatorCommittee> for rtd_sdk_types::ValidatorCommittee {
    type Error = TryFromProtoError;
...
impl From<rtd_sdk_types::CircomG1> for CircomG1 {
    fn from(value: rtd_sdk_types::CircomG1) -> Self {
...
impl TryFrom<&CircomG1> for rtd_sdk_types::CircomG1 {
    type Error = TryFromProtoError;
...
impl From<rtd_sdk_types::CircomG2> for CircomG2 {
    fn from(value: rtd_sdk_types::CircomG2) -> Self {
...
impl TryFrom<&CircomG2> for rtd_sdk_types::CircomG2 {
    type Error = TryFromProtoError;
...
impl From<rtd_sdk_types::ZkLoginClaim> for ZkLoginClaim {
    fn from(
        rtd_sdk_types::ZkLoginClaim { value, index_mod_4 }: rtd_sdk_types::ZkLoginClaim,
    ) -> Self {
        Self {
            value: Some(value),
...
impl TryFrom<&ZkLoginClaim> for rtd_sdk_types::ZkLoginClaim {
    type Error = TryFromProtoError;
...
impl From<rtd_sdk_types::ZkLoginProof> for ZkLoginProof {
    fn from(value: rtd_sdk_types::ZkLoginProof) -> Self {
        Self {
            a: Some(value.a.into()),
            b: Some(value.b.into()),
            c: Some(value.c.into()),
...
impl TryFrom<&ZkLoginProof> for rtd_sdk_types::ZkLoginProof {
    type Error = TryFromProtoError;
...
impl From<rtd_sdk_types::ZkLoginInputs> for ZkLoginInputs {
    fn from(value: rtd_sdk_types::ZkLoginInputs) -> Self {
        Self {
...
impl TryFrom<&ZkLoginInputs> for rtd_sdk_types::ZkLoginInputs {
    type Error = TryFromProtoError;
...
impl From<rtd_sdk_types::ZkLoginAuthenticator> for ZkLoginAuthenticator {
    fn from(value: rtd_sdk_types::ZkLoginAuthenticator) -> Self {
...
impl TryFrom<&ZkLoginAuthenticator> for rtd_sdk_types::ZkLoginAuthenticator {
    type Error = TryFromProtoError;
...
impl From<&rtd_sdk_types::ZkLoginPublicIdentifier> for ZkLoginPublicIdentifier {
    fn from(value: &rtd_sdk_types::ZkLoginPublicIdentifier) -> Self {
        Self {
...
impl TryFrom<&ZkLoginPublicIdentifier> for rtd_sdk_types::ZkLoginPublicIdentifier {
    type Error = TryFromProtoError;
...
impl TryFrom<&SignatureScheme> for rtd_sdk_types::SignatureScheme {
    type Error = TryFromProtoError;
...
impl From<rtd_sdk_types::SimpleSignature> for SimpleSignature {
    fn from(value: rtd_sdk_types::SimpleSignature) -> Self {
        let (signature, public_key) = match &value {
            rtd_sdk_types::SimpleSignature::Ed25519 {
                signature,
                public_key,
            } => (signature.as_bytes(), public_key.as_bytes()),
            rtd_sdk_types::SimpleSignature::Secp256k1 {
                signature,
                public_key,
            } => (signature.as_bytes(), public_key.as_bytes()),
            rtd_sdk_types::SimpleSignature::Secp256r1 {
                signature,
                public_key,
            } => (signature.as_bytes(), public_key.as_bytes()),
...
impl TryFrom<&SimpleSignature> for rtd_sdk_types::SimpleSignature {
    type Error = TryFromProtoError;

    fn try_from(value: &SimpleSignature) -> Result<Self, Self::Error> {
        use SignatureScheme;
        use rtd_sdk_types::Ed25519PublicKey;
        use rtd_sdk_types::Ed25519Signature;
        use rtd_sdk_types::Secp256k1PublicKey;
        use rtd_sdk_types::Secp256k1Signature;
        use rtd_sdk_types::Secp256r1PublicKey;
        use rtd_sdk_types::Secp256r1Signature;
...
impl From<rtd_sdk_types::PasskeyAuthenticator> for PasskeyAuthenticator {
    fn from(value: rtd_sdk_types::PasskeyAuthenticator) -> Self {
        Self {
...
impl TryFrom<&PasskeyAuthenticator> for rtd_sdk_types::PasskeyAuthenticator {
    type Error = TryFromProtoError;
...
impl From<&rtd_sdk_types::MultisigMemberPublicKey> for MultisigMemberPublicKey {
    fn from(value: &rtd_sdk_types::MultisigMemberPublicKey) -> Self {
        use rtd_sdk_types::MultisigMemberPublicKey::*;
...
impl TryFrom<&MultisigMemberPublicKey> for rtd_sdk_types::MultisigMemberPublicKey {
    type Error = TryFromProtoError;
    ...
    fn try_from(value: &MultisigMemberPublicKey) -> Result<Self, Self::Error> {
        ...
        match value.scheme() {
            ...
            SignatureScheme::Passkey => Self::Passkey(rtd_sdk_types::PasskeyPublicKey::new(
...
impl From<&rtd_sdk_types::MultisigMember> for MultisigMember {
    fn from(value: &rtd_sdk_types::MultisigMember) -> Self {
        Self {
...
impl TryFrom<&MultisigMember> for rtd_sdk_types::MultisigMember {
    type Error = TryFromProtoError;
...
impl From<&rtd_sdk_types::MultisigCommittee> for MultisigCommittee {
    fn from(value: &rtd_sdk_types::MultisigCommittee) -> Self {
        Self {
...
impl TryFrom<&MultisigCommittee> for rtd_sdk_types::MultisigCommittee {
    type Error = TryFromProtoError;
...
impl From<&rtd_sdk_types::MultisigMemberSignature> for MultisigMemberSignature {
    fn from(value: &rtd_sdk_types::MultisigMemberSignature) -> Self {
        use rtd_sdk_types::MultisigMemberSignature::*;
...
impl TryFrom<&MultisigMemberSignature> for rtd_sdk_types::MultisigMemberSignature {
    type Error = TryFromProtoError;
...
impl From<&rtd_sdk_types::MultisigAggregatedSignature> for MultisigAggregatedSignature {
    fn from(value: &rtd_sdk_types::MultisigAggregatedSignature) -> Self {
        Self {
...
impl TryFrom<&MultisigAggregatedSignature> for rtd_sdk_types::MultisigAggregatedSignature {
    type Error = TryFromProtoError;
    ...
    fn try_from(value: &MultisigAggregatedSignature) -> Result<Self, Self::Error> {
        ...
        if let Some(legacy_bitmap) = value.legacy_bitmap_opt() {
            let legacy_bitmap =
                rtd_sdk_types::Bitmap::deserialize_from(legacy_bitmap).map_err(|e| {
...
impl From<rtd_sdk_types::UserSignature> for UserSignature {
    fn from(value: rtd_sdk_types::UserSignature) -> Self {
        Self::merge_from(value, &FieldMaskTree::new_wildcard())
    }
}

impl Merge<rtd_sdk_types::UserSignature> for UserSignature {
    fn merge(&mut self, source: rtd_sdk_types::UserSignature, mask: &FieldMaskTree) {
...
impl TryFrom<&UserSignature> for rtd_sdk_types::UserSignature {
    type Error = TryFromProtoError;
