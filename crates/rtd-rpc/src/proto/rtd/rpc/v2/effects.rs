...
impl From<rtd_sdk_types::TransactionEffects> for TransactionEffects {
    fn from(value: rtd_sdk_types::TransactionEffects) -> Self {
        Self::merge_from(&value, &FieldMaskTree::new_wildcard())
    }
}

impl Merge<&rtd_sdk_types::TransactionEffects> for TransactionEffects {
    fn merge(&mut self, source: &rtd_sdk_types::TransactionEffects, mask: &FieldMaskTree) {
        ...
        match source {
            rtd_sdk_types::TransactionEffects::V1(v1) => self.merge(v1.as_ref(), mask),
            rtd_sdk_types::TransactionEffects::V2(v2) => self.merge(v2.as_ref(), mask),
        }
    }
}
...
impl TryFrom<&TransactionEffects> for rtd_sdk_types::TransactionEffects {
...
impl Merge<&rtd_sdk_types::TransactionEffectsV1> for TransactionEffects {
    fn merge(
        &mut self,
        rtd_sdk_types::TransactionEffectsV1 {
            status,
            epoch,
            gas_used,
...
impl Merge<&rtd_sdk_types::TransactionEffectsV2> for TransactionEffects {
    fn merge(
        &mut self,
        rtd_sdk_types::TransactionEffectsV2 {
            status,
            epoch,
            gas_used,
            transaction_digest,
...
impl From<rtd_sdk_types::ChangedObject> for ChangedObject {
    fn from(value: rtd_sdk_types::ChangedObject) -> Self {
        ...
        let input_state = match value.input_state {
            rtd_sdk_types::ObjectIn::NotExist => InputObjectState::DoesNotExist,
            rtd_sdk_types::ObjectIn::Exist {
                version,
                digest,
                owner,
            } => {
        ...
        let output_state = match value.output_state {
            rtd_sdk_types::ObjectOut::NotExist => OutputObjectState::DoesNotExist,
            rtd_sdk_types::ObjectOut::ObjectWrite { digest, owner } => {
                message.output_digest = Some(digest.to_string());
                message.output_owner = Some(owner.into());
                OutputObjectState::ObjectWrite
            }
            rtd_sdk_types::ObjectOut::PackageWrite { version, digest } => {
                message.output_version = Some(version);
                message.output_digest = Some(digest.to_string());
                OutputObjectState::PackageWrite
            }
            rtd_sdk_types::ObjectOut::AccumulatorWrite(accumulator_write) => {
...
impl TryFrom<&ChangedObject> for rtd_sdk_types::ChangedObject {
    type Error = TryFromProtoError;
    ...
    fn try_from(value: &ChangedObject) -> Result<Self, Self::Error> {
        ...
        let input_state = match value.input_state() {
            ...
            InputObjectState::DoesNotExist => rtd_sdk_types::ObjectIn::NotExist,
            InputObjectState::Exists => rtd_sdk_types::ObjectIn::Exist {
                version: value
                    .input_version
        ...
        let output_state = match value.output_state() {
            ...
            OutputObjectState::DoesNotExist => rtd_sdk_types::ObjectOut::NotExist,
            OutputObjectState::ObjectWrite => rtd_sdk_types::ObjectOut::ObjectWrite {
                digest: value
                    .output_digest
                    .as_ref()
                    .ok_or_else(|| TryFromProtoError::missing("digest"))?
            ...
            OutputObjectState::PackageWrite => rtd_sdk_types::ObjectOut::PackageWrite {
                version: value
                    .output_version
                    .ok_or_else(|| TryFromProtoError::missing("version"))?,
                digest: value
            ...
            OutputObjectState::AccumulatorWrite => rtd_sdk_types::ObjectOut::AccumulatorWrite(
                value
...
impl From<rtd_sdk_types::IdOperation> for changed_object::IdOperation {
    fn from(value: rtd_sdk_types::IdOperation) -> Self {
        use rtd_sdk_types::IdOperation::*;
...
impl TryFrom<changed_object::IdOperation> for rtd_sdk_types::IdOperation {
    type Error = TryFromProtoError;
...
impl From<rtd_sdk_types::AccumulatorWrite> for AccumulatorWrite {
    fn from(value: rtd_sdk_types::AccumulatorWrite) -> Self {
        ...
        message.set_operation(match value.operation() {
            rtd_sdk_types::AccumulatorOperation::Merge => AccumulatorOperation::Merge,
            rtd_sdk_types::AccumulatorOperation::Split => AccumulatorOperation::Split,
            _ => AccumulatorOperation::Unknown,
        });

        match value.value() {
            rtd_sdk_types::AccumulatorValue::Integer(v) => {
                message.set_value_kind(ProtoAccumulatorValue::Integer);
                message.set_integer_value(*v);
            }
            rtd_sdk_types::AccumulatorValue::IntegerTuple(first, second) => {
                message.set_value_kind(ProtoAccumulatorValue::IntegerTuple);
                message.integer_tuple = vec![*first, *second];
            }
            rtd_sdk_types::AccumulatorValue::EventDigest(entries) => {
...
impl TryFrom<&AccumulatorWrite> for rtd_sdk_types::AccumulatorWrite {
    type Error = TryFromProtoError;
    ...
    fn try_from(value: &AccumulatorWrite) -> Result<Self, Self::Error> {
        ...
        let accumulator_value = match value.value_kind() {
            ...
            accumulator_write::AccumulatorValue::IntegerTuple => {
                ...
                rtd_sdk_types::AccumulatorValue::IntegerTuple(
...
impl From<rtd_sdk_types::UnchangedConsensusObject> for UnchangedConsensusObject {
    fn from(value: rtd_sdk_types::UnchangedConsensusObject) -> Self {
        use rtd_sdk_types::UnchangedConsensusKind::*;
...
impl TryFrom<&UnchangedConsensusObject> for rtd_sdk_types::UnchangedConsensusObject {
    type Error = TryFromProtoError;
