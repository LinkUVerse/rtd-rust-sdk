...
impl From<rtd_sdk_types::ExecutionStatus> for ExecutionStatus {
    fn from(value: rtd_sdk_types::ExecutionStatus) -> Self {
        match value {
            rtd_sdk_types::ExecutionStatus::Success => Self {
                success: Some(true),
                error: None,
            },
            rtd_sdk_types::ExecutionStatus::Failure { error, command } => {
...
impl TryFrom<&ExecutionStatus> for rtd_sdk_types::ExecutionStatus {
    ...
    fn try_from(value: &ExecutionStatus) -> Result<Self, Self::Error> {
        ...
        match (success, &value.error) {
            ...
            (false, Some(error)) => Self::Failure {
                error: rtd_sdk_types::ExecutionError::try_from(error)
...
impl From<rtd_sdk_types::ExecutionError> for ExecutionError {
    fn from(value: rtd_sdk_types::ExecutionError) -> Self {
        use execution_error::ErrorDetails;
        use execution_error::ExecutionErrorKind;
        use rtd_sdk_types::ExecutionError as E;
...
impl TryFrom<&ExecutionError> for rtd_sdk_types::ExecutionError {
    type Error = TryFromProtoError;
    ...
    fn try_from(value: &ExecutionError) -> Result<Self, Self::Error> {
        ...
        match value.kind() {
            ...
            K::RtdMoveVerificationError => Self::RtdMoveVerificationError,
            ...
            K::RtdMoveVerificationTimedout => Self::RtdMoveVerificationTimedout,
...
impl From<rtd_sdk_types::CommandArgumentError> for CommandArgumentError {
    fn from(value: rtd_sdk_types::CommandArgumentError) -> Self {
        use command_argument_error::CommandArgumentErrorKind;
        use rtd_sdk_types::CommandArgumentError as E;
...
impl TryFrom<&CommandArgumentError> for rtd_sdk_types::CommandArgumentError {
    type Error = TryFromProtoError;
...
impl From<rtd_sdk_types::TypeArgumentError> for type_argument_error::TypeArgumentErrorKind {
    fn from(value: rtd_sdk_types::TypeArgumentError) -> Self {
        use rtd_sdk_types::TypeArgumentError::*;
...
impl TryFrom<type_argument_error::TypeArgumentErrorKind> for rtd_sdk_types::TypeArgumentError {
    type Error = TryFromProtoError;
...
impl From<rtd_sdk_types::PackageUpgradeError> for PackageUpgradeError {
    fn from(value: rtd_sdk_types::PackageUpgradeError) -> Self {
        use package_upgrade_error::PackageUpgradeErrorKind;
        use rtd_sdk_types::PackageUpgradeError as E;
...
impl TryFrom<&PackageUpgradeError> for rtd_sdk_types::PackageUpgradeError {
    type Error = TryFromProtoError;
...
impl From<rtd_sdk_types::MoveLocation> for MoveLocation {
    fn from(value: rtd_sdk_types::MoveLocation) -> Self {
        Self {
...
impl TryFrom<&MoveLocation> for rtd_sdk_types::MoveLocation {
    type Error = TryFromProtoError;
