...
impl From<rtd_sdk_types::Object> for Object {
    fn from(value: rtd_sdk_types::Object) -> Self {
...
impl Merge<rtd_sdk_types::Object> for Object {
    fn merge(&mut self, source: rtd_sdk_types::Object, mask: &FieldMaskTree) {
        if mask.contains(Self::BCS_FIELD.name) {
        ...
        match source.data() {
            rtd_sdk_types::ObjectData::Struct(move_struct) => {
                self.merge(move_struct, mask);
            }
            rtd_sdk_types::ObjectData::Package(move_package) => {
...
impl Merge<&rtd_sdk_types::MoveStruct> for Object {
    fn merge(&mut self, source: &rtd_sdk_types::MoveStruct, mask: &FieldMaskTree) {
        if mask.contains(Self::OBJECT_TYPE_FIELD.name) {
...
impl Merge<&rtd_sdk_types::MovePackage> for Object {
    fn merge(&mut self, source: &rtd_sdk_types::MovePackage, mask: &FieldMaskTree) {
        if mask.contains(Self::OBJECT_TYPE_FIELD.name) {
...
fn try_extract_struct(value: &Object) -> Result<rtd_sdk_types::MoveStruct, TryFromProtoError> {
    let version = value
        .version
    ...
    rtd_sdk_types::MoveStruct::new(object_type, has_public_transfer, version, contents).ok_or_else(
        || TryFromProtoError::invalid(Object::CONTENTS_FIELD, "contents missing object_id"),
    )
}

#[allow(clippy::result_large_err)]
fn try_extract_package(value: &Object) -> Result<rtd_sdk_types::MovePackage, TryFromProtoError> {
...
impl TryFrom<&Object> for rtd_sdk_types::Object {
    ...
    fn try_from(value: &Object) -> Result<Self, Self::Error> {
        ...
        let object_data = if value.object_type() == PACKAGE_TYPE {
            // Package
            rtd_sdk_types::ObjectData::Package(try_extract_package(value)?)
        } else {
            // Struct
            rtd_sdk_types::ObjectData::Struct(try_extract_struct(value)?)
        };
...
impl From<rtd_sdk_types::TypeOrigin> for TypeOrigin {
    fn from(value: rtd_sdk_types::TypeOrigin) -> Self {
        Self {
...
impl TryFrom<&TypeOrigin> for rtd_sdk_types::TypeOrigin {
    type Error = TryFromProtoError;
...
impl From<rtd_sdk_types::GenesisObject> for Object {
    fn from(value: rtd_sdk_types::GenesisObject) -> Self {
...
impl TryFrom<&Object> for rtd_sdk_types::GenesisObject {
    type Error = TryFromProtoError;
...
impl From<rtd_sdk_types::ObjectReference> for ObjectReference {
    fn from(value: rtd_sdk_types::ObjectReference) -> Self {
...
impl TryFrom<&ObjectReference> for rtd_sdk_types::ObjectReference {
    type Error = TryFromProtoError;
...
impl From<rtd_sdk_types::Owner> for Owner {
    fn from(value: rtd_sdk_types::Owner) -> Self {
        use owner::OwnerKind;
        use rtd_sdk_types::Owner::*;
...
impl TryFrom<&Owner> for rtd_sdk_types::Owner {
    type Error = TryFromProtoError;
