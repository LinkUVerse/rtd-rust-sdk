...
use rtd_crypto::bls12381::ValidatorCommitteeSignatureVerifier;
use rtd_sdk_types::Address;
use rtd_sdk_types::Object;
use rtd_sdk_types::ObjectReference;
use rtd_sdk_types::SignedCheckpointSummary;
use rtd_sdk_types::ValidatorCommittee;
use rtd_sdk_types::proof::OcsInclusionProof;
use rtd_sdk_types::proof::OcsNonInclusionProof;

use crate::Client;
use crate::field::FieldMask;
use crate::field::FieldMaskUtil;
use crate::proto::TryFromProtoError;
use crate::proto::rtd::rpc::v2::GetCheckpointRequest;
use crate::proto::rtd::rpc::v2alpha::GetCheckpointObjectProofRequest;
use crate::proto::rtd::rpc::v2alpha::get_checkpoint_object_proof_response;
...
/// [`LedgerService.GetObject`](crate::proto::rtd::rpc::v2::ledger_service_client::LedgerServiceClient).
...
/// committee.
///
/// `LightClient` owns a [`Client`] for talking to a Rtd gRPC endpoint and
...
impl LightClient {
    ...
    ///
    /// 1. Call the alpha
    ///    [`ProofService.GetCheckpointObjectProof`](crate::proto::rtd::rpc::v2alpha::proof_service_client)
...
fn verify_inclusion(
    ...
    object_id: &Address,
    inclusion_proto: crate::proto::rtd::rpc::v2alpha::OcsInclusionProof,
) -> Result<CheckpointObjectProof, LightClientError> {
...
fn verify_non_inclusion(
    signed_summary: &SignedCheckpointSummary,
    object_id: &Address,
    non_inclusion_proto: crate::proto::rtd::rpc::v2alpha::OcsNonInclusionProof,
) -> Result<CheckpointObjectProof, LightClientError> {
