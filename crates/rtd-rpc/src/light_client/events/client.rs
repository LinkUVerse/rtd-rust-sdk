...
use rtd_sdk_types::framework::EventStreamHead;
...
use crate::proto::rtd::rpc::v2::EventFilter;
use crate::proto::rtd::rpc::v2::ListEventsRequest;
use crate::proto::rtd::rpc::v2::ListTransactionsRequest;
use crate::proto::rtd::rpc::v2::QueryEndReason;
use crate::proto::rtd::rpc::v2::QueryOptions;
use crate::proto::rtd::rpc::v2::TransactionFilter;
use crate::proto::rtd::rpc::v2::filter::event;
use crate::proto::rtd::rpc::v2::filter::transaction;
...
/// [`EventStreamHead`](rtd_sdk_types::framework::EventStreamHead).
...
async fn reconcile_once(
    ...
    stream_head_object_id: &rtd_sdk_types::Address,
    config: &AuthenticatedEventsConfig,
...
fn build_filter(stream_id: rtd_sdk_types::Address) -> EventFilter {
    EventFilter::matching(event::event_stream_head(stream_id))
}

fn build_affected_object_filter(object_id: &rtd_sdk_types::Address) -> TransactionFilter {
