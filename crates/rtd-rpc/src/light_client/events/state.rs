...
use rtd_sdk_types::framework::EventBatch;
use rtd_sdk_types::framework::EventCommitment;
use rtd_sdk_types::framework::EventStreamHead;
use rtd_sdk_types::framework::apply_stream_updates;
...
/// `rtd::dynamic_field::Field<rtd::accumulator::Key<EventStreamHead>,
...
mod tests {
    ...
    fn extract_event_stream_head_skips_uid_and_key_prefix() {
        use rtd_sdk_types::Object;
        use rtd_sdk_types::ObjectData;
        use rtd_sdk_types::Owner;
        use rtd_sdk_types::Version;
        ...
        let move_struct = rtd_sdk_types::MoveStruct::new(
            StructTag::new(
                Address::TWO,
