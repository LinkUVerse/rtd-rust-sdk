...
use rtd_sdk_types::ValidatorAggregatedSignature;
...
use crate::proto::rtd::rpc::v2::GetEpochRequest;
...
async fn fetch_one_epoch(
    ...
    epoch_number: u64,
    config: &RatchetConfig,
) -> Result<crate::proto::rtd::rpc::v2::Epoch, LightClientError> {
...
mod tests {
    ...
    use rtd_sdk_types::EndOfEpochData;
    use rtd_sdk_types::GasCostSummary;
    use rtd_sdk_types::ValidatorCommitteeMember;
