...
use rtd_sdk_types::framework::ApplyStreamError;
use rtd_sdk_types::framework::EventStreamHead;
use rtd_sdk_types::proof::ProofError;
...
pub enum LightClientError {
    ...
    InvalidSignature(rtd_crypto::SignatureError),
    ...
    ///
    /// [`apply_stream_updates`]: rtd_sdk_types::framework::apply_stream_updates
...
impl From<rtd_crypto::SignatureError> for LightClientError {
    fn from(value: rtd_crypto::SignatureError) -> Self {
