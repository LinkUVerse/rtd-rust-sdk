...
use crate::proto::rtd::rpc::v2::ExecuteTransactionRequest;
use crate::proto::rtd::rpc::v2::ExecuteTransactionResponse;
use crate::proto::rtd::rpc::v2::ExecutionError;
use crate::proto::rtd::rpc::v2::GetEpochRequest;
use crate::proto::rtd::rpc::v2::GetTransactionRequest;
use crate::proto::rtd::rpc::v2::GetTransactionResponse;
...
impl Client {
    ...
    pub async fn execute_transaction_and_wait_for_checkpoint(
        ...
        let executed_txn_digest = match rtd_sdk_types::Transaction::try_from(transaction) {
