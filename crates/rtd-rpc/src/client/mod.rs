...
use crate::proto::rtd::rpc::v2::ledger_service_client::LedgerServiceClient;
use crate::proto::rtd::rpc::v2::move_package_service_client::MovePackageServiceClient;
use crate::proto::rtd::rpc::v2::signature_verification_service_client::SignatureVerificationServiceClient;
use crate::proto::rtd::rpc::v2::state_service_client::StateServiceClient;
use crate::proto::rtd::rpc::v2::subscription_service_client::SubscriptionServiceClient;
use crate::proto::rtd::rpc::v2::transaction_execution_service_client::TransactionExecutionServiceClient;
#[cfg(feature = "unstable")]
use crate::proto::rtd::rpc::v2alpha::proof_service_client::ProofServiceClient;
...
/// A gRPC client for the Rtd fullnode RPC interface.
///
...
/// # use rtd_rpc::Client;
/// # use rtd_rpc::client::{TransactionStreamRequest, TransactionStreamStart};
/// #
...
impl Client {
    /// URL for the public-good, Rtd Foundation provided fullnodes for mainnet.
    pub const MAINNET_FULLNODE: &str = "https://fullnode.mainnet.rtd.io";

    /// URL for the public-good, Rtd Foundation provided fullnodes for testnet.
    pub const TESTNET_FULLNODE: &str = "https://fullnode.testnet.rtd.io";

    /// URL for the public-good, Rtd Foundation provided fullnodes for devnet.
    pub const DEVNET_FULLNODE: &str = "https://fullnode.devnet.rtd.io";

    /// URL for the public-good, Rtd Foundation provided archive for mainnet.
    pub const MAINNET_ARCHIVE: &str = "https://archive.mainnet.rtd.io";

    /// URL for the public-good, Rtd Foundation provided archive for testnet.
    pub const TESTNET_ARCHIVE: &str = "https://archive.testnet.rtd.io";
