...
impl FaucetClient {
    ...
    pub const TESTNET: &str = "https://faucet.testnet.rtd.io";
    /// URL for the devnet faucet.
    pub const DEVNET: &str = "https://faucet.devnet.rtd.io";
...
"Missing X-Turnstile-Token header. For testnet tokens, please use the Web UI: https://faucet.rtd.io"
            ),
