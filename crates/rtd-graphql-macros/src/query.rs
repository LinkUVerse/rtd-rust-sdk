...
//! `rtd-graphql` crate ships a `macro_rules!` wrapper that nests this macro
...
const SCHEMA_DIAGNOSTIC_LABEL: &str = "<rtd schema>";
...
/// The resolved and validated Rtd schema used to type-check incoming queries.
    ...
    E: Into<BluejayError>,
{
    ...
    format!("Failed to {action} Rtd GraphQL schema:\n{formatted}")
}
