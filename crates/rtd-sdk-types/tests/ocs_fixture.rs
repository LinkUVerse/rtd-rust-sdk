//! Known-answer tests for OCS proof verification against a real Rtd
//! checkpoint.
//!
...
//!
//! The fixture was lifted from PR #223 of LinkUVerse/rtd-rust-sdk
//! (`crates/rtd-authenticated-events-client/tests/test_files/ocs/1137.chk`
//! at commit 25a17590), where it was originally captured for the
//! relocated authenticated-events client.
//!
//! [`TransactionEffects::object_changes`]: rtd_sdk_types::TransactionEffects::object_changes
...
use rtd_sdk_types::CheckpointCommitment;
use rtd_sdk_types::CheckpointData;
use rtd_sdk_types::CheckpointSummary;
use rtd_sdk_types::Digest;
use rtd_sdk_types::ObjectChange;
...
fn recompute_artifacts_digest(tree_root: Digest) -> Digest {
    ...
    rtd_sdk_types::hash::Hasher::digest(bytes)
}
