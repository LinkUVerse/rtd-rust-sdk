//! Rust definitions of move/rtd framework types.
...
///
/// Mirrors `rtd::accumulator_settlement::EventCommitment` on the Move side.
///
/// [`Event`]: crate::Event
///
/// # BCS
...
/// head reflects.
///
/// Mirrors `rtd::accumulator_settlement::EventStreamHead`.
///
...
/// `rtd::accumulator::Key<rtd::accumulator_settlement::EventStreamHead>`,
...
/// use rtd_sdk_types::framework::derive_event_stream_head_object_id;
///
/// // Pinned interop vector cross-verified against
/// // `rtd_types::accumulator_root::derive_event_stream_head_object_id`.
...
pub fn derive_event_stream_head_object_id(stream_id: Address) -> Address {
    ...
    // Value type: `rtd::accumulator_settlement::EventStreamHead`. Captured
    ...
    // Key type: `rtd::accumulator::Key<EventStreamHead>`.
...
/// `rtd-framework/sources/accumulator_settlement.move`. Any divergence
...
mod test {
    ...
    // `rtd::accumulator_settlement::EventCommitment` upstream byte-for-byte,
    ...
    // running `rtd_types::accumulator_root::build_event_merkle_root`
    ...
    // `rtd-framework/sources/accumulator_settlement.move`. Inserting
    ...
    // `rtd_light_client::authenticated_events::mmr::apply_stream_updates`
