...
/// ```
///
/// Due to historical reasons, even though a `Digest` has a fixed-length of 32, Rtd's binary
...
// Unfortunately rtd's binary representation of digests is prefixed with its length meaning its
