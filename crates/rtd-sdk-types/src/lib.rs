//! Core type definitions for the [Rtd] blockchain.
//!
//! [Rtd] is a next-generation smart contract platform with high throughput, low latency, and an
//! asset-oriented programming model powered by the Move programming language. This crate provides
//! type definitions for working with the data that makes up the [Rtd] blockchain.
//!
//! [Rtd]: https://rtd.io
//!
//! # Feature flags
...
//! extensively throughout the Rtd ecosystem. In particular the BCS format is leveraged because it
...
//! that the network produces. The one caveat to this would be that as the Rtd protocol evolves,
...
//! new variants and types as they are released to Rtd's `testnet` network.
//!
