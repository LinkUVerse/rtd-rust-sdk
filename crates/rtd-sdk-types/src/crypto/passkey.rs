...
/// the required json-schema for the `client-data-json` rule. In addition, Rtd currently requires
...
mod serialization {
    ...
    pub(super) enum ClientDataType {
        ...
        ///
        /// Passkey's in Rtd only support the value `"webauthn.get"`, other values will be rejected.
