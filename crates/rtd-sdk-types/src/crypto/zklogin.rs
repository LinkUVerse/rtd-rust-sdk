...
/// ## Note
///
/// Due to a historical bug that was introduced in the Rtd Typescript SDK when the zklogin
...
/// these addresses, the Rtd network decided to change the protocol to allow for a zklogin
