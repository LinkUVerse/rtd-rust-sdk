...
/// A basic signature
///
/// This enumeration defines the set of simple or basic signature schemes supported by Rtd. Most
/// signature schemes supported by Rtd end up comprising of a at least one simple signature scheme.
///
/// # BCS
///
...
/// of the types in Rtd. In particular if a signature is ever embedded in another structure it
...
mod serialization {
    ...
    mod test {
        ...
        fn passkey_fixtures() {
            const FIXTURES: &[&str] = &[
                "",
            ];
